...
/**gsap.to(".p1",1.5,{x:0,duration:2,rotation:360, repeat:2, yoyo:true});**/
...
work.from(".about-img", 1.5, { x: -200, duration: 1.5 });
...
work1.from(".about-container", 1.5, { y: 400, duration: 1.5 });
...
work1.from(".cards-top", { x: -200, duration: 1.5 });
...
work3.from(".imgs-top", { x: -200, duration: 1.5 });
...
work4.from(".buttons", { x: 200, duration: 1.5 });

/**SECTION 5**/

let work5 = gsap.timeline({
...
work5.form(".cardprice-top ",{x: -300, duration:1.5});
